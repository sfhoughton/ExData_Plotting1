##  plot2.R script to download Electric consumption data and create Global Active Power by day/time line plot
##  Creates file plot2.png containing the line plot
...
##  Create the line plot with black lines, a Y-axis label
